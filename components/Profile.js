                ...
                <div className='flex '>
                    ...
                    <div className='w-[30%] p-5'>
                        ...
                        <div className='bg-white w-full rounded-lg shadow-lg'>
                            <p className='text-center p-5 font-semibold'>Suggested Contacts</p>
                            <div className='p-5'>
                                <div className='flex items-center justify-between space-x-6'>
                                    <Image src='https://i.pinimg.com/originals/4a/3b/1a/4a3b1abae4f1f97688d1250222552bef.png' className='rounded-xl'
                                        height={50} width={50} />
                                    <div>
                                        <p className='font-semibold'>Anna</p>
                                        <p className='text-xs text-[#4B41F1]'>MIT Professor</p>
                                    </div>

                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle opacity="0.2" cx="12" cy="12" r="12" fill="#FF9E87" />
                                        <path d="M12 7.99994V15.9999" stroke="#150B3D" stroke-width="1.5" stroke-linecap="round" />
                                        <path d="M16 12L8 12" stroke="#150B3D" stroke-width="1.5" stroke-linecap="round" />
                                    </svg>
                            ...
                            <div className='p-5'>
                                <div className='flex items-center justify-between space-x-6'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-xs text-[#FB0098]'>Research Scholar</p>
                                    </div>
                            ...
                            <div className='p-5'>
                                <div className='flex items-center justify-between space-x-6'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-xs text-[#F16641]'>Career Coach</p>
                                    </div>
