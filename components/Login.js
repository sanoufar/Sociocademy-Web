...
function Login({ signIn }) {
    return (
        <div
            className="bg-[#f6f9fd] h-[100vh]
        "
        >
            <div
                className="ml-auto mr-auto h-[100vh] relative
            ...
            >
                <Image
                    ...
                    objectFit="contain"
                />
                <h1 className="text-3xl pb-5 font-bold font-sans">
                ...
                <p className="text-base">
                    ...
                    <span className="font-medium">
                        {" "}
                        email address you use at your Institution.
                    </span>
                </p>
                ...
                <div className="w-[50%] ml-auto mr-auto my-5 space-y-5">
                    ...
                    <p className="text-left font-medium text-sm">
                        ...
                        Service, User Terms of Service, Privacy Policy, and
                        Cookie Policy.
                    </p>
                </div>
                <div
