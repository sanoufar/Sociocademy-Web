        ...
        <div className='flex flex-col'>
            <div className='p-5 bg-white mt-5 rounded-t-2xl shadow-md'>
                <div className='flex items-center space-x-2'>
                    <Image src="https://links.papareact.com/4zn"
                        height={60} width={60} className="rounded-full" alt="" />
                    <div>
                        <p className="font-medium">Digital University of Kerala</p>
                ...
                <div className='max-w-2xl pt-4 px-1'>
                    <p className='font-semibold'>What are the characteristics of a fake job call form?</p>
                    <p className='pt-3 font-normal'>Because I always find fake job calls so I'm confused which job to take can you share
                        your knowledge here? thank you</p>
                </div>
            ...
            </div >
            {
                ...
                <div className='relative  md:h-96 bg-white'>
                    <Image src="https://img.onmanorama.com/content/dam/mm/en/career-and-campus/top-news/images/2021/2/21/digital-varcity.jpg"
