import { AcademicCapIcon, BookOpenIcon, CalendarIcon, ChatIcon, ChevronLeftIcon, ChevronRightIcon, CogIcon, LibraryIcon, ShareIcon, UserGroupIcon, UserIcon } from '@heroicons/react/outline'
      ...
      <div className='absolute'>
        ...
        flex space-x-3 items-center transition-all duration-300'>
          {
            [...Array(drawer)].map((e, i) => <>
              <div className='  ' onClick={() => setCurrent('Feed')} >
        ...
        <div className='   w-fit  space-y-3 h-fit pb-5'>
          <div className='relative  px-3 pb-0 cursor-pointer '
            ...
            >
              <div>
                <div onClick={() => setCurrent('Academic')} className='flex space-x-5 rounded-xl rounded-b-none
                 p-3 w-full items-center hover:bg-[#1C1F37] cursor-pointer hover:text-white'>
                  <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1H7C8.06087 1 9.07828 1.42143 9.82843 2.17157C10.5786 2.92172 11 3.93913 11 5V19C11 18.2044 10.6839 17.4413 10.1213 16.8787C9.55871 16.3161 8.79565 16 8 16H1V1Z" fill="#D9D9D9" stroke="#0C0202" stroke-opacity="0.65" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M21 1H15C13.9391 1 12.9217 1.42143 12.1716 2.17157C11.4214 2.92172 11 3.93913 11 5V19C11 18.2044 11.3161 17.4413 11.8787 16.8787C12.4413 16.3161 13.2044 16 14 16H21V1Z" fill="#D9D9D9" stroke="#0C0202" stroke-opacity="0.65" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <p>Lecture Hall</p>
                </div>
                ...
                <div className='flex space-x-5  p-3 w-full items-center hover:bg-[#1C1F37] cursor-pointer hover:text-white'>
                  <svg width="25" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.4378 6.00098C16.021 6.98392 17.8564 9.48334 17.8564 12.4115C17.8564 12.7958 17.8248 13.1728 17.764 13.5399M8.56193 6.00098C5.97878 6.98392 4.14331 9.48334 4.14331 12.4115C4.14331 12.7958 4.17493 13.1728 4.23572 13.5399M15.0918 17.9137C13.9496 18.7645 12.5335 19.268 10.9999 19.268C9.46618 19.268 8.05012 18.7645 6.90796 17.9137" stroke="#A49EB5" stroke-width="1.5" />
                    <path d="M13.4378 6.00098C16.021 6.98392 17.8564 9.48334 17.8564 12.4115C17.8564 12.7958 17.8248 13.1728 17.764 13.5399M8.56193 6.00098C5.97878 6.98392 4.14331 9.48334 4.14331 12.4115C4.14331 12.7958 4.17493 13.1728 4.23572 13.5399M15.0918 17.9137C13.9496 18.7645 12.5335 19.268 10.9999 19.268C9.46618 19.268 8.05012 18.7645 6.90796 17.9137" stroke="#333333" stroke-width="1.5" />
                    <circle cx="11" cy="5.34826" r="2.50316" stroke="#A49EB5" stroke-width="1.5" />
                    <circle cx="11" cy="5.34826" r="2.50316" stroke="#333333" stroke-width="1.5" />
                    <circle cx="16.9104" cy="16.0149" r="2.50316" stroke="#A49EB5" stroke-width="1.5" />
                    <circle cx="16.9104" cy="16.0149" r="2.50316" stroke="#333333" stroke-width="1.5" />
                    <circle cx="5.08641" cy="16.0149" r="2.50316" stroke="#A49EB5" stroke-width="1.5" />
                    <circle cx="5.08641" cy="16.0149" r="2.50316" stroke="#333333" stroke-width="1.5" />
                  </svg>
                ...
                <div onClick={() => setCurrent('Community')} className='flex space-x-5  p-3 w-full items-center hover:bg-[#1C1F37] cursor-pointer hover:text-white'>
                  <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_218_1255)">
                      ...
                      <path d="M14.1667 1.83325L10 6.41659L5.83337 1.83325" stroke="#332F2F" stroke-opacity="0.8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <defs>
            ...
            <div className='bg-white p-2 rounded-full shadow-lg'>
              <div className={`${current == "Spaces" && "bg-[#6E798C]"} rounded-full p-2 text-white`} onClick={() => setCurrent('Spaces')}>
                <svg width="28" height="25" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill={current == "Spaces" ? "white" : "black"} fill-rule="evenodd" clip-rule="evenodd" d="M7.25 3.75C7.25 1.67893 8.92893 0 11 0C13.0711 0 14.75 1.67893 14.75 3.75C14.75 5.82107 13.0711 7.5 11 7.5C8.92893 7.5 7.25 5.82107 7.25 3.75Z" />
                  <path fill={current == "Spaces" ? "white" : "black"} fill-rule="evenodd" clip-rule="evenodd" d="M14.75 6.75C14.75 5.09315 16.0931 3.75 17.75 3.75C19.4069 3.75 20.75 5.09315 20.75 6.75C20.75 8.40685 19.4069 9.75 17.75 9.75C16.0931 9.75 14.75 8.40685 14.75 6.75Z" />
                  <path fill={current == "Spaces" ? "white" : "black"} fill-rule="evenodd" clip-rule="evenodd" d="M1.25 6.75C1.25 5.09315 2.59315 3.75 4.25 3.75C5.90685 3.75 7.25 5.09315 7.25 6.75C7.25 8.40685 5.90685 9.75 4.25 9.75C2.59315 9.75 1.25 8.40685 1.25 6.75Z" />
                  <path fill={current == "Spaces" ? "white" : "black"} fill-rule="evenodd" clip-rule="evenodd" d="M5.30986 12.1175C6.50783 10.2444 8.60835 9 11 9C13.3919 9 15.4927 10.2447 16.6906 12.1182C17.5187 13.4134 17.877 14.9752 17.709 16.4979C17.6827 16.7359 17.5444 16.947 17.3368 17.0662C15.4694 18.1376 13.3051 18.75 11 18.75C8.69492 18.75 6.53059 18.1376 4.66325 17.0662C4.45559 16.947 4.3173 16.7359 4.29103 16.4979C4.12293 14.9749 4.48141 13.4129 5.30986 12.1175Z" />
                  <path fill={current == "Spaces" ? "white" : "black"} d="M4.08228 11.2537C4.07024 11.2722 4.05827 11.2907 4.04638 11.3093C3.08091 12.8189 2.63908 14.6167 2.77471 16.389C2.16667 16.2967 1.5767 16.1481 1.01043 15.9487L0.89547 15.9082C0.685759 15.8343 0.539227 15.6439 0.521591 15.4222L0.511923 15.3007C0.504017 15.2014 0.5 15.1011 0.5 15C0.5 12.9851 2.08905 11.3414 4.08228 11.2537Z" />
                  <path fill={current == "Spaces" ? "white" : "black"} d="M19.2256 16.389C19.3612 14.617 18.9196 12.8196 17.9545 11.3102C17.9424 11.2913 17.9303 11.2725 17.9181 11.2537C19.9111 11.3416 21.5 12.9853 21.5 15C21.5 15.1011 21.496 15.2014 21.4881 15.3007L21.4784 15.4222C21.4608 15.6439 21.3142 15.8343 21.1045 15.9082L20.9896 15.9487C20.4234 16.1481 19.8336 16.2966 19.2256 16.389Z" />
                </svg>
